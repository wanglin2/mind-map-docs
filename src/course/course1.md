...
`icon`可以使用内置的图标，完整图标可以在[icons.js](https://github.com/wanglin2/mind-map/blob/main/simple-mind-map/src/svg/icons.js)文件中查看。也可以扩展图标，参考[扩展图标](./course19.html#扩展图标)。

创建实例时还支持传递其他很多选项参数，完整选项列表可以在[实例化选项](../api/constructor/constructor-options.html)查看。
